class KQGDGiaoDichTuDoanhTopStockFilterForIframe:
    endpoint = "KQGDGiaoDichTuDoanhTopStockFilterForIframe"  # Keyword để Playwright định tuyến đúng Parser

    def parse(self, json_array):
        """
        Hàm ép phẳng JSON (Linearization) cho dữ liệu Giao dịch tự doanh (Mua ròng/Bán ròng)
        """
        ...
        linearized_text = "\n[BẢNG: GIAO DỊCH TỰ DOANH - TOP MUA BÁN RÒNG]\n"
        ...
        for stock in top_mua:
            ...
            # Format văn bản với các trường Khối lượng và Giá trị
